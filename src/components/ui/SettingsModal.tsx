      ...
      <div style={{ width: 500, background: themeVars.bg, border: `1px solid ${themeVars.border}`, borderRadius: 28, padding: 32, boxShadow: '0 25px 50px rgba(0,0,0,0.6)', animation: 'springUp 0.4s ease' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 28 }}>
          <h2 style={{ fontSize: 24, fontWeight: 700, margin: 0, display: 'flex', alignItems: 'center', gap: 12 }}>
            <Settings size={24} color="#7c3aed" /> Setelan Agent
          </h2>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          {/* Theme Selection */}
          <div>
            <label style={{ display: 'block', fontSize: 11, fontWeight: 700, color: themeVars.textMuted, marginBottom: 12, textTransform: 'uppercase', letterSpacing: '0.1em' }}>Mode Tampilan</label>
          ...
          {/* Language Selection */}
          <div>
            <label style={{ display: 'block', fontSize: 11, fontWeight: 700, color: themeVars.textMuted, marginBottom: 12, textTransform: 'uppercase', letterSpacing: '0.1em' }}>Bahasa</label>
          ...
          <div>
            <label style={{ display: 'block', fontSize: 11, fontWeight: 700, color: themeVars.textMuted, marginBottom: 12, textTransform: 'uppercase', letterSpacing: '0.1em' }}>Kecerdasan Personal</label>
            <div style={{ position: 'relative' }}>
              ...
              <textarea 
                ...
                placeholder="Kasih tahu ZENIX preferensi tradingmu..."
                rows={4}
        ...
        <div style={{ marginTop: 40, display: 'flex', gap: 14 }}>
          <button onClick={onClose} style={{ flex: 1, padding: '16px', borderRadius: 16, border: 'none', background: 'transparent', color: themeVars.textMuted, fontWeight: 600, cursor: 'pointer' }}>Batal</button>
          <button onClick={onSave} style={{ flex: 2, padding: '16px', borderRadius: 16, border: 'none', background: 'linear-gradient(135deg, #7c3aed, #a855f7)', color: '#fff', fontWeight: 700, cursor: 'pointer', boxShadow: '0 12px 24px -6px rgba(124, 58, 237, 0.4)' }}>Simpan Perubahan</button>
        </div>
      </div>
    </div>
  );
