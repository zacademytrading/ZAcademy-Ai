...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Settings Modal - RESTORED PREMIUM VERSION */}
      {settingsOpen && (
          ...
          <div style={{ width: 500, background: themeVars.bg, border: `1px solid ${themeVars.border}`, borderRadius: 28, padding: 32, boxShadow: '0 25px 50px rgba(0,0,0,0.6)', animation: 'springUp 0.4s ease' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 28 }}>
              <h2 style={{ fontSize: 24, fontWeight: 700, margin: 0, display: 'flex', alignItems: 'center', gap: 12 }}>
                <Settings className="w-6 h-6 text-[#7c3aed]" /> Setelan Agent
              </h2>
              <button onClick={() => setSettingsOpen(false)} style={{ background: 'rgba(239,68,68,0.1)', border: 'none', color: '#ef4444', cursor: 'pointer', borderRadius: '50%', width: 36, height: 36, display: 'flex', alignItems: 'center', justifyContent: 'center' }}><X size={20} /></button>
            </div>
